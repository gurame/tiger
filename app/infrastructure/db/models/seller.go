...
func (q sellerQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Seller, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbcontext: failed to execute a one query for seller")
	}
...
func (q sellerQuery) All(ctx context.Context, exec boil.ContextExecutor) (SellerSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "dbcontext: failed to assign all query results to Seller slice")
	}
...
func (q sellerQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbcontext: failed to count seller rows")
	}
...
func (q sellerQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "dbcontext: failed to check if seller exists")
	}
...
func FindSeller(ctx context.Context, exec boil.ContextExecutor, sellerid string, selectCols ...string) (*Seller, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbcontext: unable to select from seller")
	}
...
func (o *Seller) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("dbcontext: no seller provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "dbcontext: unable to insert into seller")
	}
...
func (o *Seller) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("dbcontext: unable to update seller, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbcontext: unable to update seller row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbcontext: failed to get rows affected by update for seller")
	}
...
func (q sellerQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbcontext: unable to update all for seller")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbcontext: unable to retrieve rows affected for seller")
	}
...
func (o SellerSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if len(cols) == 0 {
		return 0, errors.New("dbcontext: update all requires at least one column argument")
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbcontext: unable to update all in seller slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbcontext: unable to retrieve rows affected all in update all seller")
	}
	return rowsAff, nil
}
...
func (o *Seller) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("dbcontext: no seller provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("dbcontext: unable to upsert seller, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "dbcontext: unable to upsert seller")
	}
...
func (o *Seller) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("dbcontext: no Seller provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbcontext: unable to delete from seller")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbcontext: failed to get rows affected by delete for seller")
	}
...
func (q sellerQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("dbcontext: no sellerQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "dbcontext: unable to delete all from seller")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbcontext: failed to get rows affected by deleteall for seller")
	}
...
func (o SellerSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbcontext: unable to delete all from seller slice")
	}
...
func (o *Seller) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbcontext: no Seller provided for reload")
	}
...
func (o *SellerSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbcontext: empty SellerSlice provided for reload all")
	}
...
func (o *SellerSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "dbcontext: unable to reload all in SellerSlice")
	}
...
func SellerExists(ctx context.Context, exec boil.ContextExecutor, sellerid string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "dbcontext: unable to check if seller exists")
	}
